...
import supabaseTriggerTesting from '/public/assets/supabase-trigger-testing.png';
...
This means that a webhook should have been successfully set up for your Supabase Project.

To test, you can go to your [Supabase Project](https://supabase.com/dashboard) > **Integrations** > **Webhooks**, and check if a webhook has been created with the same endpoint as specified in the post-connection preview, along with the same event subscriptions.

<Image src={supabaseTriggerTesting} alt='Supabase Trigger Testing' width={1200} />

## Input / Output Mapping and Get Data

You can map your Supabase Trigger payload for the subscribed events to be passed as inputs to your workflow. Supabase sends a different structure of payload for different events.
