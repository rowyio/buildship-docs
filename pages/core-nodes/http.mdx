...
import http1 from '/public/nodes/http-1.png';
...
<Image src={http1} alt="HTTP Node" width={1200} />
...
<Callout type="info">
We can test the HTTP nodes either via node or workflow testing. The node testing allows us to test the node individually, while the workflow testing allows us to test the entire workflow. [Learn more](/testing)
</Callout>
