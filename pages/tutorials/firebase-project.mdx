...
<p>
    If you don't provide a Project ID, BuildShip will store the data in the **underlying Firebase project associated with your BuildShip account**. However, **users will only be able to access this data via BuildShip**. Access to the underlying Firebase account is not available at the moment, although this feature may be added in the future.
</p>
</Callout>
