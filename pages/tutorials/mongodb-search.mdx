...
import mongodbOg from '/public/assets/mongodb-search.png';
...
By utilizing BuildShip's MongoDB Search Nodes, users can effortlessly connect to their MongoDB instances, unlocking the
ability to create APIs, scheduled jobs, and various backend workflows focused on search and indexing. This integration
minimizes the need for extensive coding, allowing users to manage search indices, documents, and configurations
efficiently within the intuitive BuildShip environment.

The MongoDB Search Nodes provide a no-code interface for working with MongoDB, ensuring seamless integration of advanced
search features into your projects. Whether you're indexing new documents, adjusting search settings, or performing
complex search queries, MongoDB Search Nodes simplify these tasks in a user-friendly manner, making powerful search
functionalities accessible to all users.
...
<Cards num={3}>
  ...
  >
    <>![Full Text Search: Quick and Efficient Document Retrieval](../../public/assets/mongo-8.png)</>
  </Card>
  <Card
    image
    arrow
  ...
  >
    <>![Creating Embeddings: Laying the Groundwork for Advanced Searches](../../public/assets/mongo-10.png)</>
  </Card>
  <Card
    image
    arrow
  ...
  >
    <>![Semantic Search: Finding Meaning in Your Data](../../public/assets/mongo-9.png)</>
  </Card>
  <Card
    image
    arrow
  ...
  >
    <>![Hybrid Search: Combining Power of Semantic and Full Text Search](../../public/assets/mongo-12.png)</>
  </Card>
</Cards>
...
2. Create a new project and configure your database as needed with sample data.
...
You must configure an Atlas Vector Search index to query data in your Atlas cluster using MongoDB Semantic Search. Atlas
Vector Search indexes enable efficient retrieval of documents based on vector similarity. The "Semantic Search" node
allows you to perform semantic searches on a MongoDB collection, enabling you to find documents that match the semantic
meaning of a search query.

To set up MongoDB semantic search in your workflow, you first need to create a Vector Search index.
...
Hybrid Search combines the power of semantic search and full-text search, leveraging both Atlas Vector Search and Atlas
Full-Text Search to provide comprehensive search results. This method combines the semantic similarity of documents with
the exact match capabilities of full-text search.
