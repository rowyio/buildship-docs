...
Create an account on [Pinecone](https://app.pinecone.io/) --> setup application and add organization (follow pinecone
tour).
...
<Image src={pineconeIndex} alt='PineCone Index' width={800} />- Give your index a name. - Add required configurations
such as dimensions and metric - Click create
