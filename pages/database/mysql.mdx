...
<Cards num={3}>
  <Card image title='Perform CRUD operations on MySQL database' href='/tutorials/mysql-crud'>
    <>![Perform CRUD operations on Supabase database in your workflows](../../public/basics/mysql.png)</>
  </Card>
</Cards>
...
<Cards num={1}>
  <Card image arrow title='Perform CRUD operations on MySQL database in your workflows' href='/tutorials/mysql-crud'>
    <>![Perform CRUD operations on MySQL database in your workflows](../../public/basics/mysql.png)</>
  </Card>
</Cards>
