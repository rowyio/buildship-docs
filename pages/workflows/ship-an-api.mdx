...
<Callout>
For making it easy to [access the values](/api-spec#accessing-request-values) for our request structure in the workflow input fields, we can specify the Request Structure in the REST API Call Trigger. [Learn more](https://docs.buildship.com/basics/api-spec#request-specification).
