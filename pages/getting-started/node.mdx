...
import infoTip from '/public/nodes/info-tip.png';
import saveNode from '/public/nodes/save-to-library.png';
...
Node can be added from the Nodes Library by clicking the "Add Node" button on the canvas between the input and output
nodes.

<Video src='/support/v2-node.mp4' />
...
<Image src={infoTip} alt='Node Info tooltip' width={1200} />
...
You can save your node to the team library by clicking the **Save to Team Library** button in the node options menu. It
helps you reuse the node in other workflows throughout the workspace and publish new version to maintain the node's
version history.

<Image src={saveNode} alt='Save Node to Team Library' width='1200' />
