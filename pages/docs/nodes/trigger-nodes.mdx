...
import triggers1 from '/public/nodes/triggers1.png'
import triggers2 from '/public/nodes/triggers2.png'
...
<Cards>
  <Card icon="✷ " title="REST API Call" href="/docs/nodes/trigger-nodes/rest-api" />
