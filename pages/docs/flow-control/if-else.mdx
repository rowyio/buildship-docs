...
description: Define a condition and perform actions based on whether it's true or false.
---

import Image from 'next/image'
import { Callout } from 'nextra/components'
import { Steps } from 'nextra/components'
import branch1 from "/public/flow-control/branch1.png"
import branch2 from "/public/flow-control/branch2.png"
import branch3 from "/public/flow-control/branch3.png"
...
<Callout type="tip" emoji="💡">
    **These comparison operators also work on strings**. You can use them to compare string values and make decisions based on string conditions.
</Callout>
