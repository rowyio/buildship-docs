...
This will return all the documents where the field “technology” is equal to “Firebase” AND the field “admin” is true OR
the field “age” is greater than or equal to 18.
...
This will return all the documents where the field “user_ref” is equal to “users/user123”. Values passed in this format
