...
<Callout>
  ...
  Learn more on how to add the Firebase ID token to the request (or for testing) in the [Firebase Authentication Trigger > Request Headers](/trigger-nodes/firebase-auth#request-headers).
</Callout>
