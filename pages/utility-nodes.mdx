...
To use a Utility Node, simply to to the Node Explorer and **select any node from the utility section** into your workflow. 
...
- **API Call:** Make HTTP requests to external APIs for data retrieval, submission, or triggering actions.
