...
<Image src={supportMessageForm} alt="Support Message Form" width={1200} />
...
- Switch to the 'Params' tab of the Node Editor.
- Select the input you wish to mark as sensitive.
- Enable the 'Sensitive' toggle for that input if it isn't already enabled.

<Image src={nodeEditorParamsTab} alt="Support Message Form" width={1200} />
