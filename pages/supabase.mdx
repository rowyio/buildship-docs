...
<Cards num={2}>
  <Card
    image
    arrow
    title='Visually build cloud functions, APIs, scheduled jobs for Supabase'
    href='https://www.youtube.com/watch?v=At_uwZbFgG4'
    target='_blank'
  >
    <>
      ![Visually build cloud functions, APIs, scheduled jobs for Supabase with no
      code](../public/integrations/supabase/cloudfunctions.png)
    </>
  </Card>
  <Card
    image
