...
You can access BuildShip Tables **directly from the CRUD node** you are using database icon. Once you click on the table
icon available on the **BuildShip Database** node, you'll be prompted to create a new table or select an existing table.
